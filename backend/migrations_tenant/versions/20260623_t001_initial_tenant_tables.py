...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("source", sa.String(120), nullable=True),
        sa.Column("status", postgresql.ENUM("active", "inactive", "prospect", "churned", name="customer_status_enum", create_type=False, schema="public"), nullable=False),
        sa.Column("lifecycle_stage", postgresql.ENUM("onboarding", "active", "at_risk", "renewal_due", "renewed", "churned", name="customer_lifecycle_stage_enum", create_type=False, schema="public"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("stage", postgresql.ENUM("discovery", "proposal", "negotiation", "closed_won", "closed_lost", name="deal_stage_enum", create_type=False, schema="public"), nullable=False),
        sa.Column("expected_close", sa.Date(), nullable=True),
        sa.Column("status", postgresql.ENUM("open", "won", "lost", "on_hold", name="deal_status_enum", create_type=False, schema="public"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("priority", postgresql.ENUM("low", "medium", "high", "urgent", name="task_priority_enum", create_type=False, schema="public"), nullable=False),
        sa.Column("status", postgresql.ENUM("pending", "in_progress", "completed", "cancelled", name="task_status_enum", create_type=False, schema="public"), nullable=False),
        sa.ForeignKeyConstraint(["assigned_to_id"], ["public.users.id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(["created_by_id"], ["public.users.id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(["updated_by_id"], ["public.users.id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(["deleted_by_id"], ["public.users.id"], ondelete="SET NULL"),
    ...
    op.create_table(
        ...
        sa.Column("deleted_by_id", sa.Uuid(), nullable=True),
        sa.Column("customer_id", sa.Uuid(), nullable=False),
        sa.Column("type", postgresql.ENUM("note", "call", "email", "meeting", "task", "status_change", name="activity_type_enum", create_type=False, schema="public"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("read_status", postgresql.ENUM("unread", "read", name="notification_status_enum", create_type=False, schema="public"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("pending", "awarded", "dismissed", name="referral_status_enum", create_type=False, schema="public"), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.text("now()"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("amount", sa.Numeric(12, 2), nullable=False),
        sa.Column("status", postgresql.ENUM("upcoming", "renewed", "declined", name="renewal_status_enum", create_type=False, schema="public"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("currency", sa.String(3), nullable=False),
        sa.Column("payment_status", postgresql.ENUM("pending", "received", "refunded", name="payment_status_enum", create_type=False, schema="public"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("draft", "issued", "paid", "refunded", "void", name="invoice_status_enum", create_type=False, schema="public"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("direction", postgresql.ENUM("accrued", "payable", "paid", "reversed", name="commission_direction_enum", create_type=False, schema="public"), nullable=False),
        sa.Column("amount", sa.Numeric(12, 2), nullable=False),
