...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("source", sa.String(120), nullable=True),
        sa.Column("status", sa.Enum("prospect", "active", "churned", name="customer_status_enum", create_type=False), nullable=False),
        sa.Column("lifecycle_stage", sa.Enum("onboarding", "active", "at_risk", "churned", name="customer_lifecycle_stage_enum", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("stage", sa.Enum("prospecting", "qualified", "proposal", "negotiation", "closed_won", "closed_lost", name="deal_stage_enum", create_type=False), nullable=False),
        sa.Column("expected_close", sa.Date(), nullable=True),
        sa.Column("status", sa.Enum("open", "won", "lost", name="deal_status_enum", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("pending", "in_progress", "done", "cancelled", name="task_status_enum", create_type=False), nullable=False),
        sa.ForeignKeyConstraint(["assigned_to_id"], ["public.users.id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(["created_by_id"], ["public.users.id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(["updated_by_id"], ["public.users.id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(["deleted_by_id"], ["public.users.id"], ondelete="SET NULL"),
    ...
    op.create_table(
        ...
        sa.Column("deleted_by_id", sa.Uuid(), nullable=True),
        sa.Column("customer_id", sa.Uuid(), nullable=False),
        sa.Column("type", sa.Enum("call", "email", "meeting", "note", "task", name="activity_type_enum", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("pending", "confirmed", "paid", name="referral_status_enum", create_type=False), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.text("now()"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("amount", sa.Numeric(12, 2), nullable=False),
        sa.Column("status", sa.Enum("upcoming", "renewed", "churned", name="renewal_status_enum", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("currency", sa.String(3), nullable=False),
        sa.Column("payment_status", sa.Enum("pending", "partial", "paid", "overdue", "refunded", name="payment_status_enum", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("draft", "issued", "paid", "overdue", "cancelled", name="invoice_status_enum", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("direction", sa.Enum("credit", "debit", name="commission_direction_enum", create_type=False), nullable=False),
        sa.Column("amount", sa.Numeric(12, 2), nullable=False),
